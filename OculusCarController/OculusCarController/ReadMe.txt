========================================================================
    KONSOLENANWENDUNG: OculusCarController-Projektübersicht
========================================================================

Diese OculusCarController-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre OculusCarController-Anwendung besteht.


OculusCarController.vcxproj
...
OculusCarController.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen OculusCarController.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
